...
var district = 	[
					...
					/*河南省*/
					[
						["中原区", "二七区", "管城回族区", "金水区", "上街区", "惠济区", "中牟县", "新郑市", "登封市", "荥阳市", "新密市"],
...
var expressArea, areaCont, chosetype = $("#chosetype"), areaList = $("#areaList"), areaTop = areaList.offset().top;
...
function selectC(p,c) {
	...
	if (sCity != "省直辖县级行政单位") {
		if (sCity == "东莞市" || sCity == "中山市" || sCity == "儋州市" || sCity == "嘉峪关市") {
			...
			clockArea();
		} else if (sCity == "市辖区" || sCity == "市辖县" || sCity == "无堂区划分区域") {
			expressArea += "";
		} else {
			expressArea += sCity + "-";
		}
